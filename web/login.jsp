<%-- 
    Document   : login
    Created on : 01-Feb-2024, 8:42:22 pm
    Author     : HP
--%>
...
<html>
    ...
    <style>
        body {
            ...
            height: 100vh;
            margin: 0;
            background-color: #6f42c1; /* Background color for the entire page */
        }
        ...
        .container {
            ...
            border-radius: 30px;
            box-shadow: 10px 10px 10px rgba(0, 0, 0, 0.5); /* Adding a subtle box shadow for depth */
        }
